...
@register_handler
class CentroidLongitudeHandler(FieldHandler):
    """
    Longitude half of the same centroid derivation as CentroidFromPolygonHandler
    -- returns a bare number instead of a WKT POINT string, for a target field
    that expects a numeric longitude column. Prefers geoLocationCoordinates
